    ...
    <div class="main-content">
        ...
        <main class="page-body">
            <div class="page-heading">
                ...
                <p>Modifique los datos de <strong>{{ $usuario->Usuario }}</strong></p>
            </div>

            <form method="POST" action="{{ route('usuarios.update', $usuario->ID_User) }}" style="max-width:600px">
                @csrf
                @method('PUT')
                ...
                <div class="form-card">
                    ...
                    <div class="form-field">
                        ...
                        <input type="text" id="Usuario" name="Usuario"
                               value="{{ old('Usuario', $usuario->Usuario) }}" autocomplete="off">
                    ...
                    <div style="background:#fef9c3;border:1px solid #fde047;border-radius:8px;padding:10px 14px;">
                        <span style="font-size:12px;color:#854d0e;font-weight:500">
                            ⚠️ Deje los campos de contraseña vacíos si no desea cambiarla.
                        </span>
                    </div>
